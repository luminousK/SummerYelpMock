...
@import MapKit; //MapKit, a existed framework, import whole framework
...
- (void)updateAnnotation
{
    ...
    NSArray <YelpAnnotation *> *annotations = [YelpAnnotation buildAnnotationArrayFromDataArray:[[YelpDataStore sharedInstance] dataModels]]; //base on current data model and generate new annotation
